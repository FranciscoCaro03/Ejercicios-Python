...
in_producto = input("Introduzca un producto\n")
in_precio = float(input("Introduzca el precio del producto\n"))
in_unidades = int(input("Introduzca la cantidad de producto\n"))
